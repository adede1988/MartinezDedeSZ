...
for ii = 1:length(filenames)
  ...
  %paranoia measures need to be added in!
  filenames(ii).para1 = data.para1; 
  filenames(ii).para2 = data.para2; 
  filenames(ii).para1_measure = data.para1_measure; 
  filenames(ii).para2_measure = data.para2_measure; 
...
writetable(struct2table(filenames), [datPre 'SummaryTableSZ.csv'])
